 ...
 * 提供简单易用的静态方法API
 */
export declare class BoLuoBrowser {
    private engine;
    private checker;
    private srcBuffer;
     ...
     */
    static fromFile(file: File): Promise<BoLuoBrowser>;
    /**
     * 从 Blob 创建实例（保留原有API兼容性）
     */
    static fromBlob(blob: Blob): Promise<BoLuoBrowser>;
    /**
     * 从 Blob URL 创建实例（保留原有API兼容性）
     */
    static fromBlobUrl(blobUrl: string): Promise<BoLuoBrowser>;
}
export default BoLuoBrowser;
//# sourceMappingURL=boluo-browser.d.ts.map